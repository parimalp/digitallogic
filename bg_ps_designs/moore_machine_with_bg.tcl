...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.Num_BG_Output {2} \
   CONFIG.Num_Digital_Input {1} \
   CONFIG.Num_Digital_Output {5} \
 ] $bg_digital_ps_0

  # Create port connections
  connect_bd_net -net PS_Q2 [get_bd_pins PS/Q2] [get_bd_pins bg_digital_ps_0/BGin_03]
  connect_bd_net -net Q1_q [get_bd_pins PS/Q1] [get_bd_pins bg_digital_ps_0/BGin_02] [get_bd_pins bg_digital_ps_0/Din_00]
  connect_bd_net -net bg_digital_ps_0_BGout_00 [get_bd_pins PS/D1] [get_bd_pins bg_digital_ps_0/BGout_00]
  connect_bd_net -net bg_digital_ps_0_BGout_01 [get_bd_pins PS/D2] [get_bd_pins bg_digital_ps_0/BGout_01]
  ...
  connect_bd_net -net bg_digital_ps_0_Dout_03 [get_bd_pins bg_digital_ps_0/BGin_00] [get_bd_pins bg_digital_ps_0/Dout_03]
  connect_bd_net -net bg_digital_ps_0_Dout_04 [get_bd_pins bg_digital_ps_0/BGin_01] [get_bd_pins bg_digital_ps_0/Dout_04]
