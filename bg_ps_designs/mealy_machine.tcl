...
# Hierarchical cell: yout
proc create_hier_cell_yout { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_yout() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir I Q2
  create_bd_pin -dir I Q2_n
  create_bd_pin -dir I Q3_n
  create_bd_pin -dir I ain
  create_bd_pin -dir I ain_n
  create_bd_pin -dir I reset_n
  create_bd_pin -dir O yout
  ...
  # Create port connections
  connect_bd_net -net Q1_1 [get_bd_pins Q1] [get_bd_pins xup_and4_0/b]
  connect_bd_net -net Q1_n_y [get_bd_pins Q1_n] [get_bd_pins xup_and5_0/c]
  connect_bd_net -net Q2_1 [get_bd_pins Q2] [get_bd_pins xup_and4_0/c]
  connect_bd_net -net Q2_n_y [get_bd_pins Q2_n] [get_bd_pins xup_and5_0/d]
  connect_bd_net -net Q3_n_y [get_bd_pins Q3_n] [get_bd_pins xup_and4_0/d] [get_bd_pins xup_and5_0/e]
  connect_bd_net -net ain_1 [get_bd_pins ain] [get_bd_pins xup_and4_0/a]
  connect_bd_net -net ain_n_y [get_bd_pins ain_n] [get_bd_pins xup_and5_0/b]
  connect_bd_net -net reset_n_y [get_bd_pins reset_n] [get_bd_pins xup_and5_0/a]
  connect_bd_net -net xup_and4_0_y [get_bd_pins xup_and4_0/y] [get_bd_pins xup_or2_0/a]
  connect_bd_net -net xup_and5_0_y [get_bd_pins xup_and5_0/y] [get_bd_pins xup_or2_0/b]
  connect_bd_net -net xup_or2_0_y [get_bd_pins yout] [get_bd_pins xup_or2_0/y]
...
proc create_hier_cell_NS { parentCell nameHier } {
  ...
  create_bd_pin -dir O D3
  create_bd_pin -dir I Q1
  create_bd_pin -dir O Q1_n
  create_bd_pin -dir I Q2
  create_bd_pin -dir O Q2_n
  create_bd_pin -dir I Q3
  create_bd_pin -dir O Q3_n
  create_bd_pin -dir I ain
  create_bd_pin -dir O ain_n
  ...
  connect_bd_net -net Q1_n_y [get_bd_pins Q1_n] [get_bd_pins Q1_n/y] [get_bd_pins d1/Q1_n] [get_bd_pins d2/Q1_n] [get_bd_pins d3/Q1_n]
  connect_bd_net -net Q2_n_y [get_bd_pins Q2_n] [get_bd_pins Q2_n/y] [get_bd_pins d2/Q2_n]
  connect_bd_net -net Q3_n_y [get_bd_pins Q3_n] [get_bd_pins Q3_n/y]
  connect_bd_net -net ain_n_y [get_bd_pins ain_n] [get_bd_pins ain_n/y] [get_bd_pins d1/ain_n] [get_bd_pins d2/ain_n] [get_bd_pins d3/ain_n]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: yout
  create_hier_cell_yout [current_bd_instance .] yout

  # Create port connections
  connect_bd_net -net DFF_Q1_q [get_bd_pins NS/Q1] [get_bd_pins PS/Q1] [get_bd_pins yout/Q1]
  connect_bd_net -net DFF_Q2_q [get_bd_pins NS/Q2] [get_bd_pins PS/Q2] [get_bd_pins yout/Q2]
  connect_bd_net -net DFF_Q3_q [get_bd_pins NS/Q3] [get_bd_pins PS/Q3]
  connect_bd_net -net Q1_n_y [get_bd_pins NS/Q1_n] [get_bd_pins yout/Q1_n]
  connect_bd_net -net Q2_n_y [get_bd_pins NS/Q2_n] [get_bd_pins yout/Q2_n]
  connect_bd_net -net Q3_n_y [get_bd_pins NS/Q3_n] [get_bd_pins yout/Q3_n]
  connect_bd_net -net ain_n_y [get_bd_pins NS/ain_n] [get_bd_pins yout/ain_n]
  ...
  connect_bd_net -net bg_digital_ps_0_Dout_03 [get_bd_pins NS/ain] [get_bd_pins bg_digital_ps_0/Dout_03] [get_bd_pins yout/ain]
  ...
  connect_bd_net -net reset_n_y [get_bd_pins NS/reset_n] [get_bd_pins yout/reset_n]
  connect_bd_net -net yout_yout [get_bd_pins bg_digital_ps_0/Din_00] [get_bd_pins yout/yout]
